...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    ...
    <c:forEach items="${pager.smallList}" var="worker" varStatus="status">
        ...
        <tr align="center" class="td2" onmouseover="javascript:changeBgColorOnMouseOver(this);"
            ...
            <td align="center" nowrap><a href="/ny/WorkerServlet?act=grxx_ck&worker_number=${worker.worker_number}">查看</a></td>
        </tr>
                ...
                <tr>
                    ...
                    <td nowrap width="55%" align="right">
                        <c:if test="${pager.curentPageIndex<=1}">
                            <img src="/ny/image/First_no.gif" alt="第一页" width="18" height="13" border="0">&nbsp&nbsp&nbsp
                            <img src="/ny/image/Previous_no.jpg" alt="上一页" width="14" height="13" border="0">&nbsp&nbsp&nbsp
                        </c:if>

                        <c:if test="${pager.curentPageIndex>1}">
                            <a href="/ny/WorkerServlet?act=query&cp=1&flag=ss">
                                <img src="/ny/image/First.jpg" alt="第一页" width="18" height="13" border="0">&nbsp&nbsp&nbsp
                            </a>
                            <a href="/ny/WorkerServlet?act=query&cp=${pager.curentPageIndex-1}&flag=ss">
                                <img src="/ny/image/Previous.gif" alt="上一页" width="14" height="13" border="0">&nbsp&nbsp&nbsp
                            </a>
                        </c:if>

                        <c:if test="${pager.curentPageIndex>=pager.pageCount}">
                            <img src="/ny/image/Next_no.jpg" alt="下一页" width="14" height="13" border="0">&nbsp&nbsp&nbsp
                            <img src="/ny/image/Last_no.jpg" alt="最后一页" width="18" height="13" border="0">&nbsp&nbsp&nbsp
                        </c:if>

                        <c:if test="${pager.curentPageIndex<pager.pageCount}">
                            <a href="/ny/WorkerServlet?act=query&cp=${pager.curentPageIndex+1}&flag=ss">
                                <img src="/ny/image/Next.gif" alt="下一页" width="14" height="13" border="0">&nbsp&nbsp&nbsp
                            </a>
                            <a href="/ny/WorkerServlet?act=query&cp=${pager.pageCount}&flag=ss">
                                <img src="/ny/image/Last.gif" alt="最后一页" width="18" height="13" border="0">&nbsp&nbsp&nbsp
                            </a>
