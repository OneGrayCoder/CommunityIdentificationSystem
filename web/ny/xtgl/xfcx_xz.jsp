...
<br/>
  ...
  <table width="79%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr bgcolor="#FFFFFF">
      ...
      <td width="20%"><input name="textarea40" type="text" id="textarea40" value="" size="12" class="pi">
        <span class="text">
        <input type="button" name="searchbtn" value="..." onClick="javascript:location.href='gzxx.htm'">
